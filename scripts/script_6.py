...
data = pd.read_csv('datacsv/17500_SIN_ACCESORIOS.csv', encoding='utf-8')
...
for dt in data.index:
    ...
    context = {
        ...
        'MONTO_CTO_ANTERIOR_NUM':   '{:,.2f}'.format(data['MONTO CREDITO ANTERIOR'][dt]),
    ...
    if str(data['CREDITO PV2'][dt]) != '0':
        ...
        context['MONTO_PV_NUM']  = '{:,.2f}'.format(data['MONTO PV2'][dt])
    ...
    if str(data['CREDITO PV3'][dt]) != '0':
        ...
        context['MONTO_FS_NUM' ]     =   '{:,.2f}'.format(data['MONTO FS'][dt])
    ...
    if str(data['CREDITO ENG PV'][dt]) != '0':
        ...
        context['MONTO_ENG_PV_NUM' ]     =   '{:,.2f}'.format(data['MONTO ENG PV'][dt])
    ...
    if str(data['CREDITO FS'][dt]) != '0':
        ...
        context['MONTO_ENG_FS_NUM' ]     =  '{:,.2f}'.format( data['MONTO FS'][dt])
    ...
    if str(data['CREDITO GPS'][dt]) != '0':
        ...
        context['MONTO_GPS_NUM' ]     =   '{:,.2f}'.format(data['MONTO GPS'][dt])
    ...
    if str(data['CREDITO GASTOS'][dt]) != '0':
        ...
        context['MONTO_GASTOS_NUM' ]     =   '{:,.2f}'.format(data['MONTO GASTOS'][dt])
    ...
    if str(data['CREDITO CESION PV'][dt]) != '0':
        ...
        context['MONTO_CESION_PV_NUM' ]     =   '{:,.2f}'.format(data['MONTO CESION PV'][dt])
    ...
    if str(data['CREDITO RENOVACION 2021'][dt]) != '0':
        ...
        context['MONTO_R2021_NUM' ]     =   '{:,.2f}'.format(data['MONTO RENOVACION 2021'][dt])
    ...
    if str(data['CREDITO ENRUTA'][dt]) != '0':
        ...
        context['MONTO_ENRUTA_NUM' ]     =   '{:,.2f}'.format(data['MONTO ENRUTA'][dt])
    ...
    fileDir = 'C:/Users/Gustavo Blas/OneDrive - Financera Sustentable de México SA de CV SFP/CONTRATOS OCTUBRE/contratosPRINCEPS_17500_SIN_ACCESORIOS_V2/'

    #print(nombreRuta)
    try:
        os.stat('C:/Users/Gustavo Blas/OneDrive - Financera Sustentable de México SA de CV SFP/CONTRATOS OCTUBRE/contratosPRINCEPS_17500_SIN_ACCESORIOS_V2/')
    except:
        os.mkdir('C:/Users/Gustavo Blas/OneDrive - Financera Sustentable de México SA de CV SFP/CONTRATOS OCTUBRE/contratosPRINCEPS_17500_SIN_ACCESORIOS_V2/')
