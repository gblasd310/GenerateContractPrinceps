...
data = pd.read_csv('datacsv/14500_CON_ACCESORIOS.csv', encoding='utf-8')
...
for dt in data.index:
    ...
    fileDir = 'C:/Users/Gustavo Blas/OneDrive - Financera Sustentable de México SA de CV SFP/CONTRATOS OCTUBRE/contratosPRINCEPS_14500_CON_ACCESORIOS_V2/'

    #print(nombreRuta)
    try:
        os.stat('C:/Users/Gustavo Blas/OneDrive - Financera Sustentable de México SA de CV SFP/CONTRATOS OCTUBRE/contratosPRINCEPS_14500_CON_ACCESORIOS_V2/')
    except:
        os.mkdir('C:/Users/Gustavo Blas/OneDrive - Financera Sustentable de México SA de CV SFP/CONTRATOS OCTUBRE/contratosPRINCEPS_14500_CON_ACCESORIOS_V2/')
